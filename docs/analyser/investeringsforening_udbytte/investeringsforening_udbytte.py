...
Q = np.array(q)
assert abs(Q[0, -1] - 0.13738818785475426) < 10 ** -5
assert abs(Q[1, -1] - 0.13496386260652793) < 10 ** -5
assert abs(Q[2, -1] - 0.13237117504824325) < 10 ** -5
assert abs(Q[3, -1] - 0.12957906749850334) < 10 ** -5
assert abs(Q[4, -1] - 0.12682756221461133) < 10 ** -5
assert abs(Q[5, -1] - 0.12402319743038559) < 10 ** -5
assert abs(Q[6, -1] - 0.12125203806360818) < 10 ** -5
assert abs(Q[7, -1] - 0.11866479850128653) < 10 ** -5
assert abs(Q[8, -1] - 0.11609855974539451) < 10 ** -5
assert abs(Q[9, -1] - 0.11358034636459258) < 10 ** -5
assert abs(Q[10, -1] - 0.11112615913452029) < 10 ** -5
